...
const signin = () => {
  return (
    <div className="bg-stone-500 pt-64 text-slate-100 text-center box-border font-sans leading-6 min-h-800 absolute inset-0">
      <p className="mb-20 text-4xl font-bold text-black">Sign in with:</p>
      <a
        onClick={() => signIn("google", { callbackUrl: "/" })}
        className="h-6 w-6 left-20 top-15 center cursor-pointer"
      >
        <svg
          className="flex items-center rounded-full text-center text-white h-40 no-underline border-4 border-solid border-white w-full max-w-xs m-auto hover:bg-white hover:text-black"
          viewBox="40 -20 100 100"
        >
          <path
            fill="currentColor"
